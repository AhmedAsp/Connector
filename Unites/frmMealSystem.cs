...
{
    public partial class frmMealSystem : Form
    {
        DAL.MealSystem currentobj = new DAL.MealSystem();
        List<DAL.MealSystem> lst = new List<DAL.MealSystem>();
        int ID = 0;
        public frmMealSystem()
        {
            InitializeComponent();
            BindGrid();
        }
